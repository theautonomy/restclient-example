...
* *Java*: 21
* *Build Tool*: Maven
* *Test API*: http://localhost:1080 (for HTTP request/response testing)
...
[source,bash]
----
# Start local httpbin service in docker:
...
* Base URL set to `http://localhost:1080`
...
[source,java]
----
@HttpExchange("http://localhost:1080")
...
[source]
----
🚀 Making request to: GET http://localhost:1080/get
...
* http://localhost:1080/[httpbin.org API Documentation]
