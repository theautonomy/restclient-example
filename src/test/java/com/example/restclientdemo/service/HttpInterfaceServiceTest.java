...
class HttpInterfaceServiceTest {
    ...
    @Nested
    @DisplayName("HTTP Interface Basic Operations")
    ...
    @Nested
    @DisplayName("Custom Argument Resolver Tests")
    class CustomArgumentResolverTests {
    ...
    @Nested
    @DisplayName("HTTP Interface Service Demonstration")
    class ServiceDemonstrationTests {
    ...
    @Nested
    @DisplayName("SearchQuery Factory Methods")
    class SearchQueryFactoryMethodsTests {
