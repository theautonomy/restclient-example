...
@Service
public class MoreRestClientExamples {
...
// Example usage in a main class or test
class RestClientDemo {
    public static void main(String[] args) {
        MoreRestClientExamples examples = new MoreRestClientExamples();

        System.out.println("=== Demo 1: Basic RestClient ===");
        ...
        MoreRestClientExamples.ApiClients apiClients = examples.new ApiClients();
        // You could call apiClients.getAllPosts() here in a real Spring application
